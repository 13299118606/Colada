...
// SlicerDisplayableManager includes
#include "vtkSlicerTwoDAxesDisplayableManager.h"
...
public:
  ...
  vtkWeakPointer<vtkSlicerTwoDAxesDisplayableManager> DisplayableManager;
};

//---------------------------------------------------------------------------
vtkStandardNewMacro(vtkSlicerTwoDAxesDisplayableManager);

//---------------------------------------------------------------------------
class vtkSlicerTwoDAxesDisplayableManager::vtkInternal
{
public:
  vtkInternal(vtkSlicerTwoDAxesDisplayableManager * external);
  ~vtkInternal();
  ...
  vtkSlicerTwoDAxesDisplayableManager* External;

  qSlicerApplication* app;
};

//----------------------------------------------------------------------------
const double vtkSlicerTwoDAxesDisplayableManager::vtkInternal::COLOR_INVALID[3] = {1., 0.731, 0.078};

//---------------------------------------------------------------------------
// vtkInternal methods

//---------------------------------------------------------------------------
vtkSlicerTwoDAxesDisplayableManager::vtkInternal::vtkInternal(vtkSlicerTwoDAxesDisplayableManager * external)
{
...
//---------------------------------------------------------------------------
vtkSlicerTwoDAxesDisplayableManager::vtkInternal::~vtkInternal()
{
  RemoveRendererUpdateObserver();
}

//---------------------------------------------------------------------------
void vtkSlicerTwoDAxesDisplayableManager::vtkInternal::ShowActors(bool show)
{
...
//---------------------------------------------------------------------------
void vtkSlicerTwoDAxesDisplayableManager::vtkInternal::AddRendererUpdateObserver(vtkRenderer* renderer)
{
  RemoveRendererUpdateObserver();
  if (renderer)
    {
...
//---------------------------------------------------------------------------
void vtkSlicerTwoDAxesDisplayableManager::vtkInternal::RemoveRendererUpdateObserver()
{
...
//---------------------------------------------------------------------------
void vtkSlicerTwoDAxesDisplayableManager::vtkInternal::SetupMarkerRenderer()
{
  vtkRenderer* renderer = this->External->GetRenderer();
  if (renderer==nullptr)
    {
    vtkErrorWithObjectMacro(this->External, "vtkSlicerTwoDAxesDisplayableManager"
...
//---------------------------------------------------------------------------
void vtkSlicerTwoDAxesDisplayableManager::vtkInternal::SetupAxes()
{
...
//---------------------------------------------------------------------------
void vtkSlicerTwoDAxesDisplayableManager::vtkInternal::UpdateAxes()
{
  ...
  if (!viewNode || !viewNode->GetRulerEnabled())
    ...
    vtkErrorWithObjectMacro(this->External,
                            "vtkSlicerTwoDAxesDisplayableManager::UpdateAxes()"
...
//---------------------------------------------------------------------------
vtkSlicerTwoDAxesDisplayableManager::vtkSlicerTwoDAxesDisplayableManager()
{
...
//---------------------------------------------------------------------------
void vtkSlicerTwoDAxesDisplayableManager::PrintSelf(ostream& os, vtkIndent indent)
{
  this->Superclass::PrintSelf(os, indent);
}

//---------------------------------------------------------------------------
vtkRenderer *vtkSlicerTwoDAxesDisplayableManager::vtkMarkerRenderer()
{
  return this->Internal->MarkerRenderer;
}

//---------------------------------------------------------------------------
void vtkSlicerTwoDAxesDisplayableManager::SetAnnotationsColor(double red,
                                                                 double green,
                                                                 double blue)
{
...
//---------------------------------------------------------------------------
void vtkSlicerTwoDAxesDisplayableManager::SetAnnotationsFontStyle(const char *font)
{
  if (!font)
    {
    return;
...
//---------------------------------------------------------------------------
void vtkSlicerTwoDAxesDisplayableManager::SetAnnotationsFontSize(int size)
{
...
//---------------------------------------------------------------------------
void vtkSlicerTwoDAxesDisplayableManager::Create()
{
...
//---------------------------------------------------------------------------
void vtkSlicerTwoDAxesDisplayableManager::UpdateFromViewNode()
{
...
//---------------------------------------------------------------------------
void vtkSlicerTwoDAxesDisplayableManager::OnMRMLDisplayableNodeModifiedEvent(vtkObject* vtkNotUsed(caller))
{
...
//---------------------------------------------------------------------------
void vtkSlicerTwoDAxesDisplayableManager::UpdateFromRenderer()
{
