...
#include "vtkStackLoadDisplayableManager.h"
...
//---------------------------------------------------------------------------
vtkStandardNewMacro(vtkStackLoadDisplayableManager );

//---------------------------------------------------------------------------
class vtkStackLoadDisplayableManager::vtkInternal
{
public:

  vtkInternal( vtkStackLoadDisplayableManager* external );
  ~vtkInternal();
  struct Pipeline
    {
...
private:
  vtkStackLoadDisplayableManager* External;
...
//---------------------------------------------------------------------------
vtkStackLoadDisplayableManager::vtkInternal::vtkInternal(vtkStackLoadDisplayableManager* external)
: External(external)
...
//---------------------------------------------------------------------------
vtkStackLoadDisplayableManager::vtkInternal::~vtkInternal()
{
...
//---------------------------------------------------------------------------
bool vtkStackLoadDisplayableManager::vtkInternal::UseDisplayNode(vtkMRMLTransformDisplayNode* displayNode)
{
...
//---------------------------------------------------------------------------
bool vtkStackLoadDisplayableManager::vtkInternal::IsVisible(vtkMRMLTransformDisplayNode* displayNode)
{
  return displayNode && (displayNode->GetVisibility() != 0) && (displayNode->GetVisibility2D() != 0);
}

//---------------------------------------------------------------------------
void vtkStackLoadDisplayableManager::vtkInternal::SetSliceNode(vtkMRMLSliceNode* sliceNode)
{
...
//---------------------------------------------------------------------------
void vtkStackLoadDisplayableManager::vtkInternal::UpdateSliceNode()
{
...
//---------------------------------------------------------------------------
void vtkStackLoadDisplayableManager::vtkInternal::AddTransformNode(vtkMRMLTransformNode* node)
{
...
//---------------------------------------------------------------------------
void vtkStackLoadDisplayableManager::vtkInternal::RemoveTransformNode(vtkMRMLTransformNode* node)
{
  if (!node)
    {
    return;
...
//---------------------------------------------------------------------------
void vtkStackLoadDisplayableManager::vtkInternal::UpdateDisplayableTransforms(vtkMRMLTransformNode* mNode)
{
...
//---------------------------------------------------------------------------
void vtkStackLoadDisplayableManager::vtkInternal::RemoveDisplayNode(vtkMRMLTransformDisplayNode* displayNode)
{
...
//---------------------------------------------------------------------------
void vtkStackLoadDisplayableManager::vtkInternal::AddDisplayNode(vtkMRMLTransformNode* mNode, vtkMRMLTransformDisplayNode* displayNode)
{
...
//---------------------------------------------------------------------------
void vtkStackLoadDisplayableManager::vtkInternal::UpdateDisplayNode(vtkMRMLTransformDisplayNode* displayNode)
{
...
//---------------------------------------------------------------------------
void vtkStackLoadDisplayableManager::vtkInternal::UpdateDisplayNodePipeline(vtkMRMLTransformDisplayNode* displayNode, const Pipeline* pipeline)
{
...
//---------------------------------------------------------------------------
void vtkStackLoadDisplayableManager::vtkInternal::AddObservations(vtkMRMLTransformNode* node)
{
...
//---------------------------------------------------------------------------
void vtkStackLoadDisplayableManager::vtkInternal::RemoveObservations(vtkMRMLTransformNode* node)
{
  vtkEventBroker* broker = vtkEventBroker::GetInstance();
...
//---------------------------------------------------------------------------
bool vtkStackLoadDisplayableManager::vtkInternal::IsNodeObserved(vtkMRMLTransformNode* node)
{
  vtkEventBroker* broker = vtkEventBroker::GetInstance();
...
//---------------------------------------------------------------------------
void vtkStackLoadDisplayableManager::vtkInternal::ClearDisplayableNodes()
{
...
//---------------------------------------------------------------------------
bool vtkStackLoadDisplayableManager::vtkInternal::UseDisplayableNode(vtkMRMLTransformNode* node)
{
...
//---------------------------------------------------------------------------
// vtkStackLoadDisplayableManager methods

//---------------------------------------------------------------------------
vtkStackLoadDisplayableManager::vtkStackLoadDisplayableManager()
{
...
//---------------------------------------------------------------------------
void vtkStackLoadDisplayableManager::PrintSelf(ostream& os, vtkIndent indent)
{
  this->Superclass::PrintSelf(os, indent);
  os << indent << "vtkStackLoadDisplayableManager: " << this->GetClassName() << "\n";
}

//---------------------------------------------------------------------------
void vtkStackLoadDisplayableManager::OnMRMLSceneNodeAdded(vtkMRMLNode* node)
{
...
//---------------------------------------------------------------------------
void vtkStackLoadDisplayableManager::OnMRMLSceneNodeRemoved(vtkMRMLNode* node)
{
  if ( node
...
//---------------------------------------------------------------------------
void vtkStackLoadDisplayableManager::ProcessMRMLNodesEvents(vtkObject* caller, unsigned long event, void* callData)
{
...
//---------------------------------------------------------------------------
void vtkStackLoadDisplayableManager::UpdateFromMRML()
{
  ...
  if (!scene)
    {
    vtkDebugMacro( "vtkStackLoadDisplayableManager->UpdateFromMRML: Scene is not set.");
    return;
    }
...
//---------------------------------------------------------------------------
void vtkStackLoadDisplayableManager::UnobserveMRMLScene()
{
  this->Internal->ClearDisplayableNodes();
}

//---------------------------------------------------------------------------
void vtkStackLoadDisplayableManager::OnMRMLSceneStartClose()
{
  this->Internal->ClearDisplayableNodes();
}

//---------------------------------------------------------------------------
void vtkStackLoadDisplayableManager::OnMRMLSceneEndClose()
{
  this->SetUpdateFromMRMLRequested(true);
}

//---------------------------------------------------------------------------
void vtkStackLoadDisplayableManager::OnMRMLSceneEndBatchProcess()
{
  this->SetUpdateFromMRMLRequested(true);
}

//---------------------------------------------------------------------------
void vtkStackLoadDisplayableManager::Create()
{
