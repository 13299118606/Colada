Contributing to Colada
===============================

There are many ways to contribute to Colada.

  * Submit a feature request or bug, or add to the discussion on the [Colada issue tracker][is]
  * Submit a [Pull Request][pr] to improve Colada.
...
If you are new to Colada development and you don't have push access to the Colada
...
When submitting a PR, make sure to add a `Cc: @Colada/developers` comment to
notify Colada developers of your awesome contributions. Based on the
...
* You do NOT have push access: A Colada core developer will integrate your PR.
...
[pr]: https://github.com/TierraColada/Colada/merge_requests
[is]: https://github.com/TierraColada/Colada/issues
