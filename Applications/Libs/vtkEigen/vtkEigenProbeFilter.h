...
=========================================================================*/
/**
 * @class   vtkEigenProbeFilter
 * @brief   sample data values at specified point locations
 *
 * vtkEigenProbeFilter is a filter that computes point attributes (e.g., scalars,
 ...
 *
 * @warning
 * A critical algorithmic component of vtkEigenProbeFilter is the manner in which
 ...
 *
 * @warning
 * The vtkEigenProbeFilter, once it finds the cell containing a query point, uses
...
#ifndef vtkEigenProbeFilter_h
#define vtkEigenProbeFilter_h
...
class VTKEIGEN_EXPORT vtkEigenProbeFilter : public vtkDataSetAlgorithm
{
public:
  static vtkEigenProbeFilter* New();
  vtkTypeMacro(vtkEigenProbeFilter, vtkDataSetAlgorithm);
...
private:
  vtkEigenProbeFilter(const vtkEigenProbeFilter&) = delete;
  void operator=(const vtkEigenProbeFilter&) = delete;
