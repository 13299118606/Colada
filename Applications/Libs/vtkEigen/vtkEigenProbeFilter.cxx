/*=========================================================================
  ...
  Module:    vtkEigenProbeFilter.cxx
...
vtkStandardNewMacro(vtkEigenProbeFilter);
vtkCxxSetObjectMacro(vtkEigenProbeFilter, CellLocatorPrototype, vtkAbstractCellLocator);
vtkCxxSetObjectMacro(vtkEigenProbeFilter, FindCellStrategy, vtkFindCellStrategy);

#define CELL_TOLERANCE_FACTOR_SQR 1e-6

class vtkEigenProbeFilter::vtkVectorOfArrays : public std::vector<vtkDataArray*>
{
};

//------------------------------------------------------------------------------
vtkEigenProbeFilter::vtkEigenProbeFilter()
{
...
//------------------------------------------------------------------------------
void vtkEigenProbeFilter::SetSourceConnection(vtkAlgorithmOutput* algOutput)
{
  this->SetInputConnection(1, algOutput);
}

//------------------------------------------------------------------------------
void vtkEigenProbeFilter::SetSourceData(vtkDataObject* input)
{
  this->SetInputData(1, input);
}

//------------------------------------------------------------------------------
vtkDataObject* vtkEigenProbeFilter::GetSource()
{
...
//------------------------------------------------------------------------------
vtkIdTypeArray* vtkEigenProbeFilter::GetValidPoints()
{
...
//------------------------------------------------------------------------------
int vtkEigenProbeFilter::RequestData(vtkInformation* vtkNotUsed(request),
...
//------------------------------------------------------------------------------
void vtkEigenProbeFilter::PassAttributeData(
...
//------------------------------------------------------------------------------
void vtkEigenProbeFilter::BuildFieldList(vtkDataSet* source)
{
  delete this->PointList;
  delete this->CellList;
...
// * output - output.
void vtkEigenProbeFilter::InitializeForProbing(vtkDataSet* input, vtkDataSet* output)
{
...
//------------------------------------------------------------------------------
void vtkEigenProbeFilter::InitializeOutputArrays(vtkPointData* outPD, vtkIdType numPts)
{
...
//------------------------------------------------------------------------------
void vtkEigenProbeFilter::DoProbing(
...
//------------------------------------------------------------------------------
void vtkEigenProbeFilter::Probe(vtkDataSet* input, vtkDataSet* source, vtkDataSet* output)
{
...
//------------------------------------------------------------------------------
void vtkEigenProbeFilter::ProbeEmptyPoints(
  vtkDataSet* input, int srcIdx, vtkDataSet* source, vtkDataSet* output)
{
...
//------------------------------------------------------------------------------
void vtkEigenProbeFilter::ProbeImagePointsInCell(vtkCell* cell, vtkIdType cellId, vtkDataSet* source,
...
class vtkEigenProbeFilter::ProbeImageDataWorklet
{
public:
  ProbeImageDataWorklet(vtkEigenProbeFilter* probeFilter, vtkDataSet* source, int srcBlockId,
...
private:
  vtkEigenProbeFilter* ProbeFilter;
  vtkDataSet* Source;
  int SrcBlockId;
  const double* Start;
...
//------------------------------------------------------------------------------
void vtkEigenProbeFilter::ProbePointsImageData(
...
//------------------------------------------------------------------------------
class vtkEigenProbeFilter::ProbeImageDataPointsWorklet
{
public:
  ProbeImageDataPointsWorklet(vtkEigenProbeFilter* probeFilter, vtkDataSet* input, vtkImageData* source,
...
//------------------------------------------------------------------------------
void vtkEigenProbeFilter::ProbeImageDataPoints(
...
//------------------------------------------------------------------------------
void vtkEigenProbeFilter::ProbeImageDataPointsSMP(vtkDataSet* input, vtkImageData* source, int srcIdx,
...
//------------------------------------------------------------------------------
int vtkEigenProbeFilter::RequestInformation(vtkInformation* vtkNotUsed(request),
  vtkInformationVector** inputVector, vtkInformationVector* outputVector)
{
  // get the info objects
  vtkInformation* inInfo = inputVector[0]->GetInformationObject(0);
...
//------------------------------------------------------------------------------
int vtkEigenProbeFilter::RequestUpdateExtent(vtkInformation* vtkNotUsed(request),
  vtkInformationVector** inputVector, vtkInformationVector* outputVector)
{
  // get the info objects
  vtkInformation* inInfo = inputVector[0]->GetInformationObject(0);
...
//------------------------------------------------------------------------------
void vtkEigenProbeFilter::PrintSelf(ostream& os, vtkIndent indent)
{
